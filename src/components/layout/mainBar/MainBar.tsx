        ...
        <>
          <div className=" h-[100%] grid items-between">
            ...
            <div className="h-[calc(100vh-112px)] relative ">
              <img src="/assets/image/Group 1000005762.png" className=" top-0 left-0 w-full h-full object-cover bg-cover bg-center	bg-no-repeat " alt="" />
                ...
                <div className=" grid items-center justify-center">
                  <div className=" mb-20">
                    <div className=" border-[2px] border-[#00ADEF] w-[150px] h-[150px] rounded-full grid items-center justify-center">
                      <PeopleAltIcon className="text-[#00ADEF]" style={{fontSize:"80px"}} />
                    </div>

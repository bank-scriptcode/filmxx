...
const dataTemp: any = [
  {
    ...
    startDateGasQuality: "20/03/2024",
    wobbeIndexMin: "1000",
    wobbeIndexMax: "5000",
    grossCalorificMin: "1000",
    grossCalorificMax: "5000",
    // endDate: "13/04/2024",
    // createBy: {
    //   name: "demo ABC",
    //   date: "20/01/2024",
...
let mockFix: any = [
  ...
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "startDateGasQuality",
    headValue: `StartDate Gas Quality`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
  ...
  },
  {
    ...
    searchEnable: true,
    keys: "wobbeIndexMax",
    headValue: `Wobbe Index Max`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "grossCalorificMin",
    headValue: `Gross Calorific Min`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "grossCalorificMax",
    headValue: `Gross Calorific Max`,
    bodyClass: ``,
  },
  // {
  //   sortEnable: true,
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ...
        ((f?.areaName && String(f?.areaName)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.shipperId?.name && String(f?.shipperId?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.startDateGasQuality && String(f?.startDateGasQuality)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.wobbeIndexMin && String(f?.wobbeIndexMin)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.wobbeIndexMax && String(f?.wobbeIndexMax)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.grossCalorificMin && String(f?.grossCalorificMin)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.grossCalorificMax && String(f?.grossCalorificMax)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase())
                ...
                <>
                  <div className=" grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] whitespace-nowrap">{`Select Area`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                  ...
                  <div>
                    ...
                    <div>
                      <div className="text-sm mb-2 text-[#58585A]">
                        <span className=" text-[#ED1B24]">{`*`}</span>Start Date Gas Quality
                      </div>
                      {flagActive !== 2 ? (
                        <Datepicker
                          options={{
                  ...
                  <div className="border-b-[1px] border-[#DFE4EA] h-5 "></div>
                  <div className=" grid items-center grid-cols-2 gap-3 pt-5">

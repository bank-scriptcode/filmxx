...
const dataTemp: any = [
  {
    ...
    contractMinStartDate: "20/03/2024",
    contractMaxStartDate: "20/03/2024",
    submissionDeadline: "20/03/2024",
    managementDeadline: "20/03/2024",
    // endDate: "13/04/2024",
    // updateBy: {
    //   name: "demo ABC",
    //   date: "20/01/2024",
...
let mockFix: any = [
  ...
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "contractMinStartDate",
    headValue: `Contract Min StartDate`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "contractMaxStartDate",
    headValue: `Contract Max StartDate`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "submissionDeadline",
    headValue: `Submission Deadline`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "managementDeadline",
    headValue: `Management Deadline`,
    bodyClass: ``,
  },
  // {
  //   sortEnable: true,
...
function page() {
    ...
    return (
      <>
        <div>
          ...
          <MySelect
            placeholder={
              <div className=" text-sm text-[#cacaca] whitespace-nowrap ">{`Select Type`}</div>
            }
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ((f?.type?.name && String(f?.type?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.time && String(f?.time)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.contractMinStartDate && String(f?.contractMinStartDate)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.contractMaxStartDate && String(f?.contractMaxStartDate)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.submissionDeadline && String(f?.submissionDeadline)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.managementDeadline && String(f?.managementDeadline)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
              ...
              <div className=" space-y-2 my-5 text-sm">
                <>
                  <div className=" grid grid-cols-2 gap-3">
                    ...
                    <div>
                      <div className="text-sm mb-2 text-[#58585A]">
                        <span className=" text-[#ED1B24]">{`*`}</span>Publish Date
                      </div>
                      {flagActive !== 2 ? (
                        <Datepicker
                          options={{
                  ...
                  <div className=" grid grid-cols-2 gap-3">
                    <div>
                      <div className="text-sm mb-2 text-[#58585A]">
                        <span className=" text-[#ED1B24]">{`*`}</span>Contract Min Start Date
                      </div>
                      {flagActive !== 2 ? (
                        <Datepicker
                          options={{
                    ...
                    <div>
                      <div className="text-sm mb-2 text-[#58585A]">
                        <span className=" text-[#ED1B24]">{`*`}</span>Contract Max End Date
                      </div>
                      {flagActive !== 2 ? (
                        <Datepicker
                          options={{
                  ...
                  <div className=" grid grid-cols-2 gap-3">
                    <div>
                      <div className="text-sm mb-2 text-[#58585A]">
                        <span className=" text-[#ED1B24]">{`*`}</span>Submission Deadline
                      </div>
                      {flagActive !== 2 ? (
                        <Datepicker
                          options={{
                    ...
                    <div>
                      <div className="text-sm mb-2 text-[#58585A]">
                        <span className=" text-[#ED1B24]">{`*`}</span>Management Deadline
                      </div>
                      {flagActive !== 2 ? (
                        <Datepicker
                          options={{

...
let mockFix: any = [
  ...
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "nominalCapacity",
    headValue: `Nominal Capacity (MMBTU/D)`,
    bodyClass: ``,
  },
  {
    sortEnable: true,
  ...
  },
  {
    ...
    keys: "endDate",
    headValue: `End Date`,
    bodyClass: `text-[#1473A1]`,
  },
  {
    sortEnable: true,
    searchEnable: true,
    keys: "createBy",
    headValue: `Created by`,
    bodyClass: ``,
  },
  {
    sortEnable: false,
...
function page() {
  ...
  const UiSearch = () => {
    return (
      <>
        <div>
          <div className="text-sm mb-2">Metered ID</div>
          {/* <input
              id="user"
              type="text"
              name="use"
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ((f?.meteredId && String(f?.meteredId)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.meteredPointId?.name && String(f?.meteredPointId?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
                ...
                <>
                  <div className=" grid grid-cols-4 gap-3">
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] whitespace-nowrap">{`Select Mererd Point ID`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                    ...
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] whitespace-nowrap ">{`Select Customer Type`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                  ...
                  <div className=" grid grid-cols-4 gap-3">
                    <div>
                      <div className="text-sm mb-2 whitespace-nowrap ">
                        <span className=" text-[#ED1B24]">{`*`}</span>
                    ...
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] ">{`Select Group ID`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                    ...
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] ">{`Select Quality Point`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                    ...
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] ">{`Select Nomination Point`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                  ...
                  <div className=" grid grid-cols-4 gap-3">
                    <div className=" col-span-2">
                      ...
                      <input
                        ...
                        name="use"
                        className={`text-sm pl-3 pr-3 py-2 h-[38px] w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                        placeholder={`Connecting Party Name`}
                        style={{
                          background: flagActive === 2 ? "#EFECEC" : "#ffffff",
                        }}
                        disabled={(flagActive === 2 && true) || false}
                    ...
                    <div className=" ">
                      ...
                      <input
                        ...
                        name="use"
                        className={`text-sm pl-3 pr-3 py-2 h-[38px] w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                        placeholder={`Connecting Party Phone Number`}
                        style={{
                          background: flagActive === 2 ? "#EFECEC" : "#ffffff",
                        }}
                        disabled={(flagActive === 2 && true) || false}
                    ...
                    <div className=" ">
                      ...
                      <input
                        ...
                        name="use"
                        className={`text-sm pl-3 pr-3 py-2 h-[38px] w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                        placeholder={`Connecting Party Email`}
                        style={{
                          background: flagActive === 2 ? "#EFECEC" : "#ffffff",
                        }}
                        disabled={(flagActive === 2 && true) || false}
                  ...
                  <div className=" grid grid-cols-4 gap-3">
                    ...
                    <div className=" ">
                      <div className="text-sm mb-2 ">{`Latitude`}</div>
                      <input
                        id="user"
                        type="text"
                        name="use"
                    ...
                    <div className=" ">
                      <div className="text-sm mb-2 ">{`Longitude`}</div>
                      <input
                        id="user"
                        type="text"
                        name="use"
                  ...
                  <div className=" grid grid-cols-4 gap-3">
                    ...
                    <div className=" ">
                      <div className="text-sm mb-2 ">{`Sub Area`}</div>
                      <input
                        id="user"
                        type="text"
                        name="use"

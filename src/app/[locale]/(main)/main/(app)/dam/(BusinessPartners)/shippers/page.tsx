...
const dataTemp: any = [
  {
    id: 1,
    shipperId: "NGP-S16-001(PTT)",
    shortName: "PTT",
    shipperCompanyName: "บริษัท ปตท. จำกัด (มหาชน)",
    address: "555 วิภาวดีรังสิต จตุจักร จตุจักร กรุงเทพมหานคร 10900 ",
    ercLicenseId: "กกพ 01-7/52-001",
                    ...
                    <div className="bg-[#ffffff] text-[#58585A] absolute z-[2000] rounded-md p-2 left-[30px] top-0 min-w-[100px] min-h-[20px] max-h-[80vh] overflow-y-auto cursor-default shadow-lg">
                      <div className="grid">
                        <div className="flex items-center gap-2">
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.shipperId = fil["shipperId"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">{`Shipper Id`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.shortName = fil["shortName"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">{`Short Name`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.ercLicenseId = fil["ercLicenseId"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">{`ERC License ID`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          ...
                          <div className=" whitespace-nowrap">{`Bank Account`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          ...
                          <div className=" whitespace-nowrap">Group ID</div>
                        </div>
                      </div>
                    </div>
                  </>
                    ...
                    return (
                      ...
                      >
                        ...
                        {!!dataState
                          ...
                          <td className={`${!!item?.groupId && "px-6 py-4"}`}>
                            <SettingsIcon
                              className=" cursor-pointer text-[#00ADEF]"
                              onClick={() => {
                                setGroupIdFlag(true);
                              }}
                            />
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-[10px] min-w-[500px] p-5 grid ">
              ...
              <div className=" space-y-2 my-5">
                <div className=" grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <div className="text-sm mb-2">
                      <span className=" text-[#ED1B24]">{`*`}</span>Short Name
                    </div>
                    <input
                      id="user"
                      type="text"
                ...
                <div className=" grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <div className="text-sm mb-2 text-[#ffffffff]">{`-`}</div>
                    <input
                      id="user"
                      type="text"
                      name="use"
                      className={`text-sm pl-3 pr-3 py-2 h-[38px] w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                      placeholder={`Fil in one Province, District, Subdistrict or Postcode`}
                      style={{
                        background: flagActive === 2 ? "#EFECEC" : "#ffffff",
                      }}
                      disabled={(flagActive === 2 && true) || false}
                ...
                <div className=" grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <div className="text-sm mb-2">{`FAX`}</div>
                    <input
                      id="user"
                      type="text"
                      name="use"
                ...
                <div className=" grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <MySelect
                      placeholder={
                        <div className=" text-sm text-[#cacaca] ">{`Select Bank`}</div>
                      }
                      // options={userTypeOption}

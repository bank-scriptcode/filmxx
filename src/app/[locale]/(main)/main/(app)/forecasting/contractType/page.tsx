...
const dataTemp: any = [
  {
    id: 1,
    documentName: "Shipper Term 2024",
    contractType:{
      id:1,
      name:"Long Term",
      color:"#FFDDCE"
...
function page() {
  ...
  const UiSearch = () => {
    return (
      <>
        <div>
          <div className="text-sm mb-2">Document Name</div>
        ...
        <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center gap-2">
          ...
          <div className=" flex gap-2 mt-auto ml-auto">
            <div
              ...
              className="rounded-lg bg-[#2B2A87] text-[#ffffff] w-[150px] flex gap-2 items-center justify-center h-[38px] mt-auto ml-auto text-sm cursor-pointer"
            >
              <span>{`Download`}</span>
              <DownloadIcon

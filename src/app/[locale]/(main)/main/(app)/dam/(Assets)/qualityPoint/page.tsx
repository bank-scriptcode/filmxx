...
function page() {
  ...
  const UiSearch = () => {
    ...
    return (
      <>
            <div>
              <div className="text-sm mb-2">Quality Point ID</div>
              <MySelect
                placeholder={
                  <div className=" text-sm text-[#cacaca] ">{`Select Quality Point ID`}</div>
                }
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      ...
      return (
        ((f?.qualityPointId && String(f?.qualityPointId)) || "")
          .toLowerCase()
                ...
                <>
                  <div className=" grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] whitespace-nowrap ">{`Select Point Type`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {

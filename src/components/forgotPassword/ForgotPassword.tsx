...
function ForgotPassword() {
  ...
  const changePassword = async () => {
    let locale =  await getCookie("NEXT_LOCALE")
    router.push(`/${locale || `en`}/changePassword`);
  };
        ...
        <div className=" grid item-around px-[20%]">
          ...
          <div className=" grid items-center justify-center gap-2">
            ...
            <div className=" grid gap-5 w-[380px]">
              <h3 className=" text-[#2B2A87] font-bold text-lg">{`Forgot Password`}</h3>
              <input
                id="user"
                type="text"
                name="use"
              ...
              >
                <div className="h-[48px] uppercase bg-[#F3F4F6] text-[#00ADEF] border-[#00ADEF] border-[1px] rounded-[10px] flex items-center justify-center gap-2">
                  {`Back`}
                </div>
              </div>

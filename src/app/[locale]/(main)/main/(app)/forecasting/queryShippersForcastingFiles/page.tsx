                          ...
                          >
                            {configDataRow.map((el: any, il: any) => {
                              ...
                              switch (el?.keys) {
                                case "contractType":
                                  valueShow = <>
                                  <div className=" w-fit px-5 rounded-full" style={{ background: item?.[el?.keys]?.["color"] }}>
                                    {item?.[el?.keys]?.["name"] || "-"}
                                  </div>
                                  </>
                                  break;
                                ...
                                case "shipperFile":
                                  valueShow = (
                                    <>
                                      <AttachFileIcon onClick={()=>{setModalFile((pre:any) => !pre)}} className="text-[#323232] cursor-pointer" />
                                    </>
                                  );
                                  break;
                ...
                <>
                  <div className=" grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <MySelect
                        ...
                        seUseType={seUseType}
                        setSeUseType={setSeUseType}
                        className={`w-[100%] h-[38px] text-sm border-[#DFE4EA] z-[99] ${
                  ...
                  {/* <div className=" grid grid-cols-1 gap-3">
                    <div>
                      ...
                      <div
                        className={`h-[calc(300px)] overflow-y-auto block rounded-md mt-2`}
                      >
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                          <thead className="text-xs text-[#ffffff] uppercase bg-[#1473A1] sticky top-0 z-10">
                            <tr>
                                      ...
                                      {configDataRow.map((el: any, il: any) => {
                                        ...
                                        switch (el?.keys) {
                                          ...
                                          case "contractFile":
                                            valueShow = (
                                              <>
                                                <AttachFileIcon className="text-[#323232] cursor-pointer" />
                                              </>
                                            );
                                            break;
                                          ...
                                          case "download":
                                            valueShow = (
                                              <>
                                                <DownloadIcon className="text-[#2B2A87] cursor-pointer" />
                                              </>
                                            );
                                            break;
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-[10px] min-w-[500px] p-5 grid ">
              ...
              <div className=" space-y-5 my-5 text-sm">
                ...
                <div className=" flex items-center gap-5 text-sm">
                  ...
                  <div>
                    <div className=" font-bold">{`Forecasting Code`}</div>
                    <div>{`20210426-FOR-0001`}</div>
                  </div>
                  <div>
                    <div className=" font-bold">{`Shipper ID`}</div>
                    <div>{`NGP-S16-001(PTT)`}</div>
                  </div>
                </div>
                <div className=" space-y-2">
                    <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm space-y-3">
                      ...
                      <div className="p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center justify-between">
                        <div className=" flex items-center gap-2">
                          <InsertDriveFileIcon />
                          <div>{`ShipperTerm2024V1.xlxs`}</div>
                        </div>

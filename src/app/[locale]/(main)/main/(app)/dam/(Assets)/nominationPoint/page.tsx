...
const dataTemp: any = [
  {
    ...
    latitude:"13.6511488",
    longitude:"100.630528",
    nominalCapacity:"20",
    minPressure:"100.630528",
    maxPressure:"100.630528",
...
function page() {
  ...
  useEffect(() => {
    const sortedData = [...dataStateInit].sort((a: any, b: any) => {
      if (sortBy === "nominationPointId") {
        return sortOrder === "asc"
          ? ((!!a.nominationPointId && String(a.nominationPointId)) || "").localeCompare(
              (!!b.nominationPointId && String(b.nominationPointId)) || ""
            )
          : ((!!b.nominationPointId && String(b.nominationPointId)) || "").localeCompare(
              (!!a.nominationPointId && String(a.nominationPointId)) || ""
            );
      } else if (sortBy === "pointType") {
        return sortOrder === "asc"
          ? (
              (!!a.pointType && String(a.pointType)) ||
              ""
            ).localeCompare(
              (!!b.pointType && String(b.pointType)) || ""
            )
          : (
              (!!b.pointType && String(b.pointType)) ||
              ""
        ...
        return sortOrder === "asc"
          ? (
              (!!a.latitude && String(a.latitude)) ||
              ""
            ).localeCompare(
              (!!b.latitude && String(b.latitude)) || ""
            )
          : (
              (!!b.latitude && String(b.latitude)) ||
              ""
        ...
        return sortOrder === "asc"
          ? (
              (!!a.longitude && String(a.longitude)) ||
              ""
            ).localeCompare(
              (!!b.longitude && String(b.longitude)) || ""
            )
          : (
              (!!b.longitude && String(b.longitude)) ||
              ""
      ...
      } else if (sortBy === "nominalCapacity") {
        return sortOrder === "asc"
          ? (
              (!!a.nominalCapacity && String(a.nominalCapacity)) ||
              ""
            ).localeCompare(
              (!!b.nominalCapacity && String(b.nominalCapacity)) || ""
            )
          : (
              (!!b.nominalCapacity && String(b.nominalCapacity)) ||
              ""
      ...
      } else if (sortBy === "minPressure") {
        return sortOrder === "asc"
          ? (
              (!!a.minPressure && String(a.minPressure)) ||
              ""
            ).localeCompare(
              (!!b.minPressure && String(b.minPressure)) || ""
            )
          : (
              (!!b.minPressure && String(b.minPressure)) ||
              ""
      ...
      } else if (sortBy === "maxPressure") {
        return sortOrder === "asc"
          ? (
              (!!a.maxPressure && String(a.maxPressure)) ||
              ""
            ).localeCompare(
              (!!b.maxPressure && String(b.maxPressure)) || ""
            )
          : (
              (!!b.maxPressure && String(b.maxPressure)) ||
              ""
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ((f?.nominationPointId && String(f?.nominationPointId)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.pointType?.name && String(f?.pointType?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.zone?.name && String(f?.zone?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.latitude && String(f?.latitude)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.longitude && String(f?.longitude)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.nominalCapacity && String(f?.nominalCapacity)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.minPressure && String(f?.minPressure)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.maxPressure && String(f?.maxPressure)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
    ...
    <>
      <div className="p-2 space-y-2">
        <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center gap-2 ">
          ...
          <div>
            <div className="text-sm mb-2">Nomination Point ID</div>
            <MySelect
              placeholder={
                <div className=" text-sm text-[#cacaca] whitespace-nowrap ">{`Select Nomination Point ID`}</div>
              }
              ...
              className={`min-w-[209px] h-[38px] text-sm border-[#DFE4EA]rounded-lg !focus:border-[#cacaca] z-[99]`}
          ...
          <div>
            <div className="text-sm mb-2">Point Type</div>
            <MySelect
              placeholder={
                <div className=" text-sm text-[#cacaca] ">{`Select Point Type`}</div>
              }
              // options={userTypeOption}
              options={(bankData || [])?.map((e: any) => {
                return {
          ...
          <div>
            ...
            <MySelect
              placeholder={
                <div className=" text-sm text-[#cacaca] ">{`Select Zone`}</div>
              }
              // options={userTypeOption}
              options={(bankData || [])?.map((e: any) => {
                return {
          ...
          <div>
            <div className="text-sm mb-2">Area</div>
            <MySelect
              placeholder={
                <div className=" text-sm text-[#cacaca] ">{`Select Area`}</div>
              }
              // options={userTypeOption}
              options={(bankData || [])?.map((e: any) => {
                return {
          ...
          <div className="px-2 rounded-lg bg-[#00ADEF] text-[#ffffff] grid items-center justify-center w-[38px] h-[38px] mt-auto cursor-pointer">
            <SearchIcon />
          </div>
          <div className="px-2 rounded-lg bg-[#ffffff] text-[#00ADEF] border-[1px] border-[#00ADEF] grid items-center justify-center w-[38px] h-[38px] mt-auto cursor-pointer">
          ...
          <div
            ...
            className="px-2 rounded-lg bg-[#00ADEF] text-[#ffffff] w-[150px] flex gap-2 items-center justify-center h-[38px] mt-auto ml-auto text-sm cursor-pointer"
          >
            <span>{`New`}</span>
            <AddCircleIcon
                    ...
                    <div className="bg-[#ffffff] text-[#58585A] absolute z-[2000] rounded-md p-2 left-[30px] top-0 min-w-[100px] min-h-[20px] max-h-[80vh] overflow-y-auto cursor-default shadow-lg">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "nominationPointId"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    let newObj = { ...obj };
                                    delete newObj.nominationPointId;
                                    return newObj;
                                  });
                                  return newArr;
                                });
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.nominationPointId = fil["nominationPointId"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">Nomination Point ID</div>
                        </div>
                      </div>
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "pointType"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.pointType = fil["pointType"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">Point Type</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "zone"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                          ...
                          <div className=" whitespace-nowrap">Zone</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "area"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "latitude"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                          ...
                          <div className=" whitespace-nowrap">Latitude</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "longitude"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.longitude = fil["longitude"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">Longitude</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "nominalCapacity"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.nominalCapacity = fil["nominalCapacity"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">{`Nominal Capacity (MMBTU/D)`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "minPressure"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.minPressure = fil["minPressure"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">MinPressure</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "maxPressure"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.maxPressure = fil["maxPressure"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">Max Pressure</div>
                        </div>
                      </div>
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "createBy"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                ...
                <thead className="text-xs text-[#58585A] uppercase bg-[#E5E5E5] sticky top-0 z-10">
                  <tr>
                    ...
                    {!!dataState
                      ...
                      >
                        {`Nomination Point ID`}
                        {sortBy === "nominationPointId" ? (
                          sortOrder === "asc" ? (
                            <NorthIcon
                              className=" cursor-pointer"
                              onClick={() => handleSort("contractPointId")}
                            />
                          ) : (
                            <SouthIcon
                              className=" cursor-pointer"
                    ...
                    {!!dataState
                      ...
                      >
                        {`Nominal Capacity (MMBTU/D)`}
                        {sortBy === "nominalCapacity" ? (
                          sortOrder === "asc" ? (
                            <NorthIcon
                              className=" cursor-pointer"
                      ...
                      >
                        ...
                        {sortBy === "minPressure" ? (
                          sortOrder === "asc" ? (
                            <NorthIcon
                              className=" cursor-pointer"
                              onClick={() => handleSort("minPressure")}
                            />
                          ) : (
                            <SouthIcon
                              className=" cursor-pointer"
                      ...
                      >
                        ...
                        {sortBy === "maxPressure" ? (
                          sortOrder === "asc" ? (
                            <NorthIcon
                              className=" cursor-pointer"
                              onClick={() => handleSort("maxPressure")}
                            />
                          ) : (
                            <SouthIcon
                              className=" cursor-pointer"
                    ...
                    return (
                      ...
                      >
                        ...
                        {!!dataState
                          ...
                          <td
                            className={`${
                              !!item?.nominationPointId && "px-6 py-4"
                            } whitespace-nowrap`}
                          >
                            {item?.nominationPointId || "-"}
                          </td>
                        )}
                        {!!dataState
                          .map((e: any) => hasAgeKey(e, "pointType"))
                        ...
                        {!!dataState
                          ...
                          <td
                            className={`${
                              !!item?.nominalCapacity && "px-6 py-4"
                            } whitespace-nowrap`}
                          >
                        ...
                        {!!dataState
                          ...
                          <td className={`${!!item?.createBy && "px-6 py-4"}`}>
              ...
              <>
                    ...
                    <div>
                        ...
                        <input
                          ...
                          placeholder={`Nomination Point ID`}
                          style={{
                            background:
                              flagActive === 2 ? "#EFECEC" : "#ffffff",
                          }}
                          disabled={(flagActive === 2 && true) || false}
                        />
                      </div>
                    ...
                    <div className=" grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          name="use"
                          className={`text-sm pl-3 pr-3 py-2 h-[38px] w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                          placeholder={`Nomination Capacity`}
                          style={{
                            background:
                              flagActive === 2 ? "#EFECEC" : "#ffffff",
                          }}
                    ...
                    <div className=" grid grid-cols-2 gap-3">
                      <div>
                        <div className="text-sm mb-2 text-[#58585A]">
                          <span className=" text-[#ED1B24]">{`*`}</span>Start
                          Date
                        </div>
                        {flagActive !== 2 ? (
                          <Datepicker

...
function page() {
    ...
    const sortedData = [...dataStateInit].sort((a: any, b: any) => {
      if (sortBy === "name") {
        return sortOrder === "asc"
          ? ((!!a.name && String(a.name)) || "").localeCompare(
              (!!b.name && String(b.name)) || ""
            )
          : ((!!b.name && String(b.name)) || "").localeCompare(
              (!!a.name && String(a.name)) || ""
            );
      } else if (sortBy === "contractPointId") {
        return sortOrder === "asc"
          ? (
              (!!a.contractPointId && String(a.contractPointId)) ||
              ""
            ).localeCompare(
              (!!b.contractPointId && String(b.contractPointId)) || ""
            )
          : (
              (!!b.contractPointId && String(b.contractPointId)) ||
              ""
      ...
      } else if (sortBy === "areaNominalCapacity") {
        return sortOrder === "asc"
          ? (
              (!!a.areaNominalCapacity && String(a.areaNominalCapacity)) ||
              ""
            ).localeCompare(
              (!!b.areaNominalCapacity && String(b.areaNominalCapacity)) || ""
            )
          : (
              (!!b.areaNominalCapacity && String(b.areaNominalCapacity)) ||
              ""
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ((f?.contractPointId && String(f?.contractPointId)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.area?.name && String(f?.area?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ...
        ((f?.name && String(f?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.areaNominalCapacity && String(f?.areaNominalCapacity)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
    ...
    <>
      <div className="p-2 space-y-2">
        <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center gap-2 ">
          ...
          <div>
            <div className="text-sm mb-2">Contract Point ID</div>
            <MySelect
              placeholder={
                <div className=" text-sm text-[#cacaca] ">{`Select Point ID`}</div>
              }
                    ...
                    <div className="bg-[#ffffff] text-[#58585A] absolute z-[2000] rounded-md p-2 left-[30px] top-0 min-w-[100px] min-h-[20px] max-h-[80vh] overflow-y-auto cursor-default shadow-lg">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "contractPointId"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.contractPointId = fil["contractPointId"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">Contract Point ID</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "name"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                    ...
                    return (
                      ...
                      >
                        ...
                        {!!dataState
                          ...
                          <td
                            className={`${
                              !!item?.contractPointId && "px-6 py-4"
                            } whitespace-nowrap`}
                          >
                            {item?.contractPointId || "-"}
                          </td>
                        )}
                        {!!dataState
                          .map((e: any) => hasAgeKey(e, "name"))

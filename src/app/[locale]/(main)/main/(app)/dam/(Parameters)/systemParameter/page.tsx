...
const dataTemp: any = [
  {
    ...
    systemParameter: {
      id: 1,
      name: "Offshore: Maximum allocation tolerance percentage (%)",
    },
    value: "1",
    link: "http://....",
...
function page() {
  ...
  const UiSearch = () => {
    return (
      <>
        ...
        <div>
          <div className="text-sm mb-2">Module</div>
          <MySelect
            placeholder={
              <div className=" text-sm text-[#cacaca] ">{`Select Module`}</div>
            }
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ((f?.module?.name && String(f?.module?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.systemParameter?.name && String(f?.systemParameter?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
                          ...
                          >
                            {configDataRow.map((el: any, il: any) => {
                              ...
                              switch (el?.keys) {
                                ...
                                case "link":
                                  valueShow = <>
                                  <div className=" w-fit border-[1px] border-[#A6CE3950] rounded-md p-[2px] cursor-pointer">
                                    <OpenInNewIcon className="text-[#A6CE39]" />
                                  </div>
                                  </>;
                                  break;
                ...
                <>
                  <div className=" grid grid-cols-2 gap-3">
                    <div className=" col-span-2">
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] whitespace-nowrap">{`Select Module`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {
                  ...
                  <div className=" grid grid-cols-2 gap-3">
                    <div className=" col-span-2">
                      ...
                      <MySelect
                        placeholder={
                          <div className=" text-sm text-[#cacaca] whitespace-nowrap">{`Select System Parameter`}</div>
                        }
                        // options={userTypeOption}
                        options={(bankData || [])?.map((e: any) => {
                          return {

                              ...
                              switch (el?.keys) {
                                ...
                                case "type":
                                  valueShow = (
                                    <>
                                      <div
                                        className=" w-fit px-3 rounded-full whitespace-nowrap"
                                        style={{
                                          color: item?.[el?.keys]?.["color"],
                                          background:
                                            item?.[el?.keys]?.["color"] + "30",
                                        }}
                                      >
                                        {item?.[el?.keys]?.["name"] || "-"}
                                      </div>
              ...
              <div className="w-[100%] grid justify-start items-center text-[#00ADEF] font-bold">
                {`${
                  flagActive === 1
                    ...
                    ? "Edit"
                    : "-"
                } Shirinkage Factor / Line Requirement`}
              </div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-[10px] w-[90vw] h-[90vh]  ">
              <div className="p-[20px]">
                <div className="w-[100%] h-[50px] text-[#00ADEF] font-bold grid items-center">
                  {`History Shirinkage Factor / Line Requirement`}
                </div>
              </div>

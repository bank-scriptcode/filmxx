  ...
  return (
    <>
      <header className="antialiased">
        <nav className="bg-[#ffffff] border-gray-200 px-4 lg:px-6 py-2.5 text-[#58585a]">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex items-center lg:order-2">
              ...
              {openNoti && (
                <div
                  className="absolute top-10 right-1 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700"
              ...
              {openApp && (
                <div
                  className=" absolute top-10 right-1 overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                  id="apps-dropdown"
                >
                  <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    Apps
                    ...
                    return (
                      <div className="relative" key={ix}>
                        <button
                          ...
                          className="text-[#58585a] hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium flex items-center"
                        >
                          {item?.menuName}
                          {item?.sub.length > 0 && (
                        ...
                        >
                          {(item?.sub || []).map((itemSub: any, ixSub: any) => {
                            return (
                              <div key={ixSub}>
                                <button
                                  className="block px-4 py-2 text-sm text-[#58585a] hover:bg-gray-800 min-w-48 w-fit whitespace-nowrap text-left"
                                  onClick={() => {
                                  ...
                                  {(itemSub?.sub || []).map(
                                    (itemSubs: any, ixSubs: any) => {
                                      return (
                                        <div key={ixSubs}>
                                          <button
                                            className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-800 min-w-48 w-fit whitespace-nowrap text-left"
                                            onClick={() => {
                                              setMenuState((pre: any) => {
                                                let newPre = pre.map(
                                                  (element: any) => {
                  ...
                  return (
                    <div className="relative" key={ix}>
                      <button
                        ...
                        className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium flex items-center w-[100%]"
                      >
                        {item?.menuName}
                        {item?.sub.length > 0 && (
                      ...
                      >
                        {(item?.sub || []).map((itemSub: any, ixSub: any) => {
                          return (
                            <div key={ixSub}>
                              <button
                                className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-800 w-[100%] text-left"
                                onClick={() => {
                                  if (itemSub?.sub.length === 0) {
                                    setMenuState((pre: any) => {
                                      let newPre = pre.map((element: any) => {

...
function page() {
  ...
  const saveData = async () => {
    console.log(dataUse?.operatorId);
    if (!!!dataUse?.operatorId) {
  ...
  useEffect(() => {
    const sortedData = [...dataStateInit].sort((a: any, b: any) => {
      if (sortBy === "operatorId") {
        return sortOrder === "asc"
          ? ((!!a.operatorId && String(a.operatorId)) || "").localeCompare(
              (!!b.operatorId && String(b.operatorId)) || ""
            )
          : ((!!b.operatorId && String(b.operatorId)) || "").localeCompare(
              (!!a.operatorId && String(a.operatorId)) || ""
            );
      } else if (sortBy === "name") {
        return sortOrder === "asc"
        ...
        return sortOrder === "asc"
          ? ((!!a.division && String(a.division)) || "").localeCompare(
              (!!b.division && String(b.division)) || ""
            )
          : ((!!b.telephone && String(b.telephone)) || "").localeCompare(
              (!!a.telephone && String(a.telephone)) || ""
            );
        ...
        return sortOrder === "asc"
          ? ((!!a.fax && String(a.fax)) || "").localeCompare(
              (!!b.fax && String(b.fax)) || ""
            )
          : ((!!b.fax && String(b.fax)) || "").localeCompare(
              (!!a.fax && String(a.fax)) || ""
            );
  ...
  useEffect(() => {
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ((f?.operatorId && String(f?.operatorId)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.name && String(f?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.division && String(f?.division)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
    ...
    <>
      <div className="p-2 space-y-2">
        <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center gap-2">
          <div>
            <div className="text-sm mb-2">Operator ID</div>
            <MySelect
              placeholder={
                <div className=" text-sm text-[#cacaca] ">{`Select Operator ID`}</div>
              }
                    ...
                    <div className="bg-[#ffffff] text-[#58585A] absolute z-[2000] rounded-md p-2 left-[30px] top-0 min-w-[100px] min-h-[20px] max-h-[80vh] overflow-y-auto cursor-default shadow-lg">
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "operatorId"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.operatorId = fil["operatorId"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">{`Operator ID`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "division"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                          ...
                          <div className=" whitespace-nowrap">{`Division`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          ...
                          <div className=" whitespace-nowrap">{`Fax`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
              ...
              <div className=" space-y-2 my-5">
                <div className=" grid grid-cols-2 gap-3">
                  <div>
                    ...
                    {dataUseVaridate?.operatorId && (
                      <div className="text-[#ED1B24] text-[12px] mx-1">{`Enter your operator id`}</div>
                    )}
                  </div>
                  <div>
                    <div>
                    ...
                    {dataUseVaridate?.operatorId && (
                      <div className="text-[#ED1B24] text-[12px] mx-1">{`Enter your operator name`}</div>
                    )}
                  </div>
                </div>
                <div className=" grid grid-cols-2 gap-3">
                  <div>
                    ...
                    {dataUseVaridate?.operatorId && (
                      <div className="text-[#ED1B24] text-[12px] mx-1">{`Enter your division`}</div>
                    )}
                  </div>
                  <div>
                    <div>
                    ...
                    {dataUseVaridate?.operatorId && (
                      <div className="text-[#ED1B24] text-[12px] mx-1">{`Enter your telephone`}</div>
                    )}
                  </div>
                </div>
                <div className=" grid grid-cols-2 gap-3">
                  <div>
                    ...
                    {dataUseVaridate?.operatorId && (
                      <div className="text-[#ED1B24] text-[12px] mx-1">{`Enter your email`}</div>
                    )}
                  </div>
                  <div>
                    <div>
                    ...
                    {dataUseVaridate?.operatorId && (
                      <div className="text-[#ED1B24] text-[12px] mx-1">{`Enter your fax`}</div>
                    )}
                  </div>
                </div>
                <div className=" grid grid-cols-2 gap-3">

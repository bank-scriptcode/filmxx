...
const dataTemp: any = [
  {
    id: 1,
    documentName: "Nomination",
    file: "",
    description: "TSO reject Weekly Nomination",
    // createBy: {
    //   name: "demo ABC",
    //   date: "20/01/2024",
    // },
                            ...
                            {configDataRow.map((el: any, il: any) => {
                              ...
                              switch (el?.keys) {
                                case "file":
                                  valueShow = (
                                    <>
                                      <AttachFileIcon className="text-[#FF2015] cursor-pointer" />
                                    </>
                                  );
                                  break;
                  ...
                  <div className=" grid grid-cols-2 gap-3">
                    <div className=" col-span-2">
                      ...
                      <textarea
                        ...
                        rows={10}
                        cols={30}
                        className={`text-sm pl-3 pr-3 py-2 w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                        placeholder={`Document Name`}
                        style={{
                          background: flagActive === 2 ? "#EFECEC" : "#ffffff",
                        }}

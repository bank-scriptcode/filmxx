  ...
  useEffect(() => {
    const sortedData = [...dataStateInit].sort((a: any, b: any) => {
      if (sortBy === "name") {
        ...
        return sortOrder === "asc"
          ? (
              (!!a.areaId && String(a.areaId)) ||
              ""
            ).localeCompare(
              (!!b.areaId && String(b.areaId)) || ""
            )
          : (
              (!!b.areaId && String(b.areaId)) ||
              ""
      ...
      } else if (sortBy === "zoneId") {
        return sortOrder === "asc"
          ? ((!!a.zoneId && String(a.zoneId)) || "").localeCompare(
              (!!b.zoneId && String(b.zoneId)) || ""
            )
          : ((!!b.zoneId && String(b.zoneId)) || "").localeCompare(
              (!!a.zoneId && String(a.zoneId)) || ""
            );
    ...
    let filter = dataStateTemp.filter((f: any) => {
      return (
        ...
        ((f?.areaNominalCapacity && String(f?.areaNominalCapacity)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
        ((f?.zoneId?.name && String(f?.zoneId?.name)) || "")
          .toLowerCase()
          .includes(searchField.toLowerCase()) ||
    ...
    <>
      <div className="p-2 space-y-2">
        <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center gap-2">
          <div>
            <div className="text-sm mb-2">Area ID</div>
            {/* <input
              id="user"
              type="text"
              name="use"
                    ...
                    <div className="bg-[#ffffff] text-[#58585A] absolute z-[2000] rounded-md p-2 left-[30px] top-0 min-w-[100px] min-h-[20px] max-h-[80vh] overflow-y-auto cursor-default shadow-lg">
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          ...
                          <div className=" whitespace-nowrap">Area ID</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) =>
                              hasAgeKey(e, "areaNominalCapacity")
                            )
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    let newObj = { ...obj };
                                    delete newObj.areaNominalCapacity;
                                    return newObj;
                                  });
                                  return newArr;
                                });
                              ...
                              onClick={() => {
                                setDataState((pre: any) => {
                                  let newArr = pre.map((obj: any) => {
                                    ...
                                    let newObj = { ...obj };
                                    newObj.areaNominalCapacity =
                                      fil["areaNominalCapacity"];
                                    return newObj;
                                  });
                                  return newArr;
                                });
                          ...
                          <div className=" whitespace-nowrap">{`Area Nominal Capacity (MMBTH/D)`}</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          {!!dataState
                            .map((e: any) => hasAgeKey(e, "zoneId"))
                            .find((f: any) => {
                              return f === true;
                            }) ? (
                            <CheckBoxIcon
              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                <thead className="text-xs text-[#58585A] uppercase bg-[#E5E5E5] sticky top-0 z-10">
                  <tr>
                    ...
                    {!!dataState
                      .map((e: any) => hasAgeKey(e, "areaNominalCapacity"))
                      .find((f: any) => {
                        return f === true;
                      }) && (
                      <th
                      ...
                      >
                        ...
                        {sortBy === "areaNominalCapacity" ? (
                          sortOrder === "asc" ? (
                            <NorthIcon
                              className=" cursor-pointer"
                              onClick={() => handleSort("areaNominalCapacity")}
                            />
                          ) : (
                            <SouthIcon
                              className=" cursor-pointer"
                    ...
                    return (
                      ...
                      >
                        ...
                        {!!dataState
                          ...
                          <td
                            className={`${
                              !!item?.areaNominalCapacity && "px-6 py-4"
                            } whitespace-nowrap`}
                          >
                            {item?.areaNominalCapacity || "-"}
                          </td>
                        )}
                        {!!dataState
                          .map((e: any) => hasAgeKey(e, "zoneId"))
                    ...
                    <div className=" grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          name="use"
                          className={`text-sm pl-3 pr-3 py-2 h-[38px] w-full rounded-lg border-[1px] border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                          placeholder={`Area Nominal Capacity`}
                          style={{
                            background:
                              flagActive === 2 ? "#EFECEC" : "#ffffff",
                          }}

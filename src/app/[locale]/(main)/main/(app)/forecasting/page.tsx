      ...
      <div className=" h-[100%] grid items-between">
        <div className="h-[calc(100vh-112px)] relative ">
          <img
            ...
            alt=""
          />
          <div className="absolute top-0 left-0 grid grid-cols-2 h-[calc(100vh-112px)] w-[100%] items-center justify-center">
            <div className=" grid items-center justify-center">
              <div className=" mb-20 ">
                ...
                <div className=" text-[#00ADEF] font-bold text-[40px] mt-5">{`Forecasting`}</div>
              </div>
            </div>
            <div></div>
          </div>

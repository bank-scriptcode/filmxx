    ...
    <>
      <div className="p-2 space-y-2">
        <div className=" p-3 border-[1px] border-[#DFE4EA] rounded-[10px] shadow-sm flex items-center gap-2">
          ...
          <div>
            <div className="text-sm mb-2">Zone ID</div>
            {/* <input
              id="user"
              type="text"
              name="use"
                    ...
                    <div className="bg-[#ffffff] text-[#58585A] absolute z-[2000] rounded-md p-2 left-[30px] top-0 min-w-[100px] min-h-[20px] max-h-[80vh] overflow-y-auto cursor-default shadow-lg">
                      ...
                      <div className="grid">
                        <div className="flex items-center gap-2">
                          ...
                          <div className=" whitespace-nowrap">Zone ID</div>
                        </div>
                      </div>
                      <div className="grid">
                        <div className="flex items-center gap-2">
                    ...
                    return (
                      ...
                      >
                        ...
                        {!!dataState
                          ...
                          <td className={`${!!item?.type && "px-6 py-4"}`}>
                            <div
                              className={` text-center py-1 rounded-full whitespace-nowrap px-2 font-bold`}
                              style={{ background: item?.type?.color + "30", color: item?.type?.color }}
                            >
                              {item?.type?.name || "-"}
                            </div>
                          </td>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-[10px] min-w-[500px] p-5 grid ">
              ...
              <div className=" space-y-2 my-5">
                <div className=" my-5 flex items-center gap-2 text-sm">
                  <div className={`${flagZone === 1 ? "text-[#00ADEF] border-b-[1px] border-[#00ADEF] font-bold " : " "} cursor-pointer `} onClick={()=>{
                    flagActive !== 3 && setFlagZone(1)
                    }}>{`New Zone`}</div>
                  <div className={`${flagZone === 2 ? "text-[#00ADEF] border-b-[1px] border-[#00ADEF] font-bold " : " "} cursor-pointer `}onClick={()=>{flagActive !== 3 && setFlagZone(2)}}>{`New Quality`}</div>
                </div>
                {
                  flagZone === 1 ?
                  <>
                <div className=" grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <span className=" text-[#ED1B24]">{`*`}</span>{`Zone ID`}
                    </div>
                    <MySelect
                      placeholder={
                        <div className=" text-sm text-[#cacaca] ">{`Select Zone ID`}</div>
                      }
                  ...
                  <div>
                    <div className="text-sm mb-2 text-[#58585A]">
                    <span className=" text-[#ED1B24]">{`*`}</span>{`Type`}
                    </div>
                    <MySelect
                      placeholder={
                        <div className=" text-sm text-[#cacaca] ">{`Select Type`}</div>
                      }
                      // options={userTypeOption}
                      options={(bankData || [])?.map((e: any) => {
                        return {
                ...
                <div className=" grid grid-cols-1 gap-3">
                  <div>
                    <div className="text-sm mb-2 "><span className=" text-[#ED1B24]">{`*`}</span>{`Name`}</div>
                    <input
                      id="user"
                      type="text"
                      name="use"
                ...
                <div className=" grid grid-cols-2 gap-3">
                  ...
                  <div className=" grid items-center grid-cols-2 gap-3">
                    <div className=" space-y-3">
                      ...
                      <div className=" grid items-center grid-cols-3 text-[#464255] text-sm gap-3">
                        ...
                        <div className="w-[100%]">
                          <input
                              type="text"
                              className={`text-sm w-[100%] h-[38px] px-2 rounded-lg border-[1px] bg-white border-[#DFE4EA] outline-none bg-opacity-100 focus:border-[#2B2A87]`}
                            />
                          </div>
                        <div className="w-[100%]">
                          <input
                      ...
                      <div className=" grid items-center grid-cols-3 text-[#464255] text-sm gap-3">
                        <div className=" grid items-start">
                          <div>{`Total Sulphur`}</div>
                          <div>{`(ppm by volume)`}</div>
                        </div>
                        <div className="w-[100%]">
                          <input
                              type="text"
                      ...
                      <div className=" grid items-center grid-cols-3 text-[#464255] text-sm gap-3">
                        <div className=" grid items-start">
                          <div>{`Other particulates`}</div>
                          <div>{`(ppm by weight)`}</div>
                        </div>
                        <div className="w-[100%]">
                          <input
                              type="text"
                    ...
                    <div className=" space-y-3">
                      ...
                      <div className=" grid items-center grid-cols-3 text-[#464255] text-sm gap-3">
                        <div className=" grid items-start">
                          <div className=" whitespace-nowrap">{`Gross Calorific Value`}</div>
                          <div>{`(BTU/SCF)`}</div>
                        </div>
                        <div className="w-[100%]">
                          <input

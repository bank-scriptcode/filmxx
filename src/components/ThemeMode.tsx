...
const ThemeMode = () => {
  ...
  // Determine the current theme, considering the system theme
  ...
  return (
    <button
      type="button"
      onClick={() => onSelectChangeTogle()}
      className="text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 h-[40px] px-3 text-sm rounded-full"
    >
      {/* Light theme SVG */}
